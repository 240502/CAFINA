...
namespace Businesss
{
    public class ProductBUS
    {
        ...
        public List<ProductModel> Search(int pageIndex, int pageSize, out long total, string value)
        {
            List<ProductModel> ProductList = prodDal.Search(pageIndex, pageSize, out total, value);
            return ProductList;
        }
